...
class EmailClient extends Client
{
     ...
     */
    public function sendEmailTemplate(SendEmailTemplateReq $request = null)
    {
        $resp = $this->invoke($request);
        return new SendEmailTemplateRes($resp->toArray(), $resp->getRequestId());
    }
}
