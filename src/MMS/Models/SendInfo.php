...
class SendInfo extends Response
{

    /**
     * SenderId: Sender Name is basically used to identify the sender of the bulk MMS message.
     *
     * @return string|null
     */
    ...
    public function getTarget()
    {
        ...
        foreach ($items as $i => $item) {
            array_push($result, new TargetPhone($item));
        }
        return $result;
    }
